...
convention for the forward Fourier transform, so this is the type of Fourier transform we obtain when evaluating equation (23) in their paper.
...
There are definite errors in the spectrum... are those numerical integration artifacts?
The exact spectrum should be a Gaussian again.
